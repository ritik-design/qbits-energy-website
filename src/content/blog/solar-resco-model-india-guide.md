...
keywords:
  - solar resco model india
  - solar PPA india C&I
  - solar opex model india
  - resco solar company india
  - solar power purchase agreement india
faqs:
  - q: "What is the solar RESCO model in India?"
    a: "RESCO stands for Renewable Energy Service Company. In the RESCO model, the solar developer finances, owns, installs, and operates the solar system on the buyer's roof. The buyer pays a per-unit tariff (typically ₹4–6/unit) for the electricity generated - instead of purchasing it at the grid rate (₹8–14/unit for C&I consumers). The buyer has zero upfront capital expenditure. The RESCO recovers its investment through the PPA tariff over the 15–25 year contract period."
  - q: "What is a PPA in solar?"
    a: "A PPA (Power Purchase Agreement) is the long-term contract between the solar RESCO and the C&I buyer. The PPA specifies the PPA tariff (rate per unit, e.g., ₹5/unit), the annual tariff escalation clause (typically 2–3% per year), the contract duration (15–25 years), the minimum generation guarantee, exit provisions and penalties, and the system ownership and removal obligations at contract end. The PPA is the most critical legal document to review before committing to a RESCO arrangement."
  - q: "Which are the top RESCO companies in India?"
    a: "Leading RESCO providers in India for C&I rooftop solar include: Amplus Solar (now TotalEnergies On+) - one of the largest C&I RESCO players with over 800 MW deployed; Fourth Partner Energy - focused on mid-market C&I with strong track record in manufacturing; CleanMax - known for green energy procurement structures and corporate PPA frameworks; Amp Energy - active in large industrial and commercial portfolios. Each RESCO has different minimum project sizes, preferred sectors, and PPA term structures."
  - q: "What is the typical RESCO PPA tariff in India?"
    a: "RESCO PPA tariffs in India for C&I buyers typically range from ₹4 to ₹6 per unit (kWh) depending on the buyer's grid tariff, roof size, system capacity, and the RESCO's financing cost. The PPA tariff is fixed at the initial rate with an annual escalation clause of 2–3% per year. A buyer paying ₹10/unit from the grid who switches to a ₹5/unit RESCO PPA saves ₹5/unit on self-consumed solar - approximately 30–40% bill reduction."
  - q: "What are the key risks in a solar RESCO PPA in India?"
    a: "Key risks include: tariff escalation clause (2–3% annual increase compounds significantly over 25 years, potentially narrowing savings if grid tariffs stagnate); roof ownership implications (if you sell or redevelop the building, the PPA must transfer to the new owner or exit penalties apply); system performance risk (if generation underperforms, you receive less savings); exit penalty (early termination typically requires paying a lump sum covering the RESCO's remaining projected returns); and system removal obligation at contract end."
  - q: "Can a RESCO buyer claim accelerated depreciation benefit?"
    a: "No. In the RESCO model, the solar system is owned by the RESCO company, not the C&I buyer. The RESCO company claims the 80% accelerated depreciation benefit in Year 1 under Section 32 of the Income Tax Act - this is one of the primary financial incentives that allows RESCOs to offer low PPA tariffs. C&I buyers who own the system (CAPEX model) can claim this depreciation themselves, which is a significant advantage of CAPEX over OPEX for profitable companies with high taxable income."
  - q: "What is the difference between RESCO and CAPEX solar models?"
    a: "In the CAPEX model, the C&I buyer purchases and owns the solar system outright. The buyer gets full ownership, accelerated depreciation tax benefits, higher long-term savings (60–70% bill reduction), and complete control over the asset. In the RESCO/OPEX model, the buyer pays per unit with zero capex - savings are lower (30–40% bill reduction) but there is no asset risk, no capital deployment, and no balance sheet impact. CAPEX wins financially when capital is available and the buyer has taxable profits; RESCO wins when capital is constrained or the building is rented."
  - q: "How long does a typical RESCO PPA contract last in India?"
...
The C&I RESCO market in India is served by a mix of Indian independents and international majors. Understanding each player's focus helps you identify which to invite for RFQs.

### Amplus Solar (TotalEnergies On+)

Amplus is the largest C&I rooftop solar developer in India by installed capacity. Acquired by TotalEnergies (France) in 2018, it now operates as TotalEnergies On+. Focus: large industrial, retail, and data centre projects above 500 kW. PPA tariff: ₹4.5–6/unit with 2–3% annual escalation.

### Fourth Partner Energy

Hyderabad-based, focused on the mid-market C&I segment (50 kW–5 MW). Strong track record in textile, pharma, and auto ancillary sectors. Offers both PPA and hybrid ownership structures. PPA tariff: ₹4.8–6.5/unit. Active in AP, Telangana, Karnataka, Tamil Nadu, and Maharashtra.

### CleanMax

Pune-based RESCO focused on green energy procurement for corporate buyers with ESG and RE100 commitments. Has structured innovative wheeling and captive frameworks for buyers who need renewable energy certificates (RECs). PPA tariff: ₹4.5–6/unit.
...
A RESCO PPA is a complex legal document. These terms determine financial outcome over the contract lifetime.

| PPA Term | Typical Range | What It Means |
| --- | --- | --- |
| PPA tariff (Year 1) | ₹4–6/unit | What you pay per kWh generated |
| Annual escalation | 2–3% per year | Tariff increases by this percentage each year |
| Contract duration | 15–25 years | How long the RESCO owns the system on your roof |
| Minimum generation guarantee | 80–90% of projected P90 yield | RESCO compensates you if generation falls below this |
| Roof lease fee | ₹0–₹50,000 per year | Some RESCOs pay you a roof rental; others charge nothing |
| O&M responsibility | RESCO | All maintenance, cleaning, and repairs are the RESCO's cost |
| Exit penalty | 1–3 years of projected PPA payments | Cost of early termination |
| End-of-term options | Extend, buy, or remove | Who pays for system removal |
...
| Parameter | RESCO Model | CAPEX Model |
| --- | --- | --- |
| Upfront cost | ₹0 | ₹3.5 Crore |
| Ownership | RESCO | Factory owner |
| Year 1 tariff | ₹5/unit (rising 3%/yr) | ₹0 (own electricity) |
| Grid tariff offset | ₹10/unit | ₹10/unit |
| Year 1 savings | ₹37.5 lakh | ₹75 lakh |
| Accelerated depreciation | Not applicable (RESCO claims it) | ₹5.6 lakh tax saving |
| IRR over 25 years | N/A (no capex) | 22–26% |
...
India's RESCO market is also increasingly shaped by the [Ministry of New and Renewable Energy's](https://mnre.gov.in/) frameworks for captive and open-access solar, which affect how C&I buyers structure large rooftop and ground-mounted projects for optimal regulatory and financial outcomes.
