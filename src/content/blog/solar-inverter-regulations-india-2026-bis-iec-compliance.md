...
keywords:
  ...
  - BIS IS 16221
  - MNRE inverter specifications
  - IEC 62109
  - DISCOM compliance
faqs:
  - q: "What happens with non-BIS certified inverters?"
    a: "Installation rejection during inspection, subsidy claim denial, legal penalties up to 10× equipment value, insurance coverage voidance, and potential manufacturer/installer liability. Always verify current certification before procurement."
  - q: "How long does BIS certification take?"
    a: "Typically 6–12 months for new applicants - documentation review, laboratory testing, factory inspection, and license issuance. License is valid for 1 year and renewable annually."
  - q: "Are imported inverters allowed?"
    a: "Yes, but they must obtain BIS certification identical to domestic products. Import duties and customs complexity often make imports costlier than domestic alternatives."
  - q: "Do hybrid and on-grid inverters face different regulations?"
    a: "Both require IS 16221 certification, but hybrid models need additional battery management system certifications and safe mode-transition verification."
  - q: "What are the minimum warranty requirements?"
    a: "5–10 years depending on state and project type. Coverage must include comprehensive replacement/repair with specified response times (48–72 hours typical)."
---
...
2. Testing at BIS-approved NABL-accredited laboratories
3. Factory audits by BIS inspectors
4. License issuance, valid 1 year, annually renewable

**Timeline:** 6–12 months for new applicants

### Testing Covers

- Electrical safety (insulation resistance, dielectric strength)
- Performance efficiency and MPPT accuracy
- Environmental durability (temperature, humidity, dust)
- Electromagnetic compatibility (EMC)

## IEC Standards Alignment
...
**IS 16221** harmonises with IEC while adding local grid condition requirements.

## MNRE Mandatory Performance Standards
...
| --- | --- |
| Electrical safety | Per IEC 62109 |
| Efficiency curves | 10%–100% of rated load |
...
| --- | --- |
| Non-BIS inverter installation | Inspection rejection; no grid connection |
| Missing certifications during inspection | Subsidy claim denial |
| Regulatory penalty | Up to 10× equipment value |
| Equipment failure with uncertified components | Insurance voidance |
| Repeat non-compliance | Manufacturer/installer liability |

## Verification Workflow

1. Check BIS website certification database
2. Request original certificates and test reports
3. Verify state nodal agency approved lists
4. Inspect physical BIS markings
5. Obtain manufacturer authorisation letters
