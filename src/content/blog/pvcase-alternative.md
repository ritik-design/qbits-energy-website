...
<h3>Utility-scale design plus the rest of the stack PVcase leaves out</h3>
<p>A SurgePV engineer designs one of your real ground-mount projects on a 20-minute walkthrough, including 8,760-hour shading, bankable yield, AutoCAD export, and a branded proposal.</p>
...
- **Choose PVcase** if utility-only is your entire scope and the most complex terrain optimisation is your dominant constraint.
- **Choose SurgePV** if you cover utility plus C&I plus residential, or if you want utility-scale workflow plus integrated financials and proposals at flat per-seat cost.
...
<p>SurgePV ships 8,760-hour module-level shading, bankable yield, AutoCAD export, and white-label proposals across every project size, at flat per-seat pricing.</p>
<a href="https://surgepv.com/demo" class="cta-btn" target="_blank" rel="noopener noreferrer">Book a Free Demo <svg class="cta-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="M12 8l4 4-4 4"/></svg></a>
