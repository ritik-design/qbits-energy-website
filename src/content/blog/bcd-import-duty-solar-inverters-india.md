...
keywords:
  ...
  - basic customs duty solar inverter
  - almm solar inverter india
  - made in india solar inverter almm
faqs:
  - q: "What is the Basic Customs Duty (BCD) on solar inverters imported into India?"
    a: "As of 2026, the Basic Customs Duty (BCD) on solar inverters (HS code 8504) imported into India is 20%. This applies to string inverters, central inverters, and microinverters imported from outside India, including from China, Germany, Taiwan, and all other countries. BCD is levied on the assessed customs value (CIF + landing charges). In addition to BCD, IGST at 12–18% on inverters, social welfare surcharge, and other levies apply. The total customs incidence on an imported inverter is typically 35–45% above the CIF value."
...
The [ALMM list](/glossary/almm-list/) and BCD are two separate policy instruments that work in parallel. Understanding both is essential.

### Customs Duty Structure for Solar Equipment (2026)
...
| DC cable | 8544 | 10% | 18% | ~30% |
| Battery (LFP/lithium) | 8507 | 10%–15% | 18% | ~30% |

*Rates subject to change with Union Budget notifications. Verify current rates at [CBIC](https://www.cbic.gov.in/) before procurement.*

The 20% BCD on inverters is significant but lower than the 40% on modules, reflecting the government's intent to protect domestic module manufacturing most aggressively, while inverter manufacturing is at an earlier stage of domestic development.

### How Total Customs Incidence Is Calculated

The Import Duty Impact Calculator applies the following formula:
...
| --- | --- | --- |
| BCD (20%) | ₹40,000 × 20% | ₹8,000 |
| SWS (10% of BCD) | ₹8,000 × 10% | ₹800 |
| IGST base | ₹40,000 + ₹8,000 + ₹800 | ₹48,800 |
| IGST (18%) | ₹48,800 × 18% | ₹8,784 |
| **Total duties** | | **₹17,584** |
...
Apply this five-step framework to any inverter procurement decision involving an imported product:
...
- SWS: ₹500
- IGST (18%): ₹5,490
- Landed cost: ₹35,990 vs ₹25,000 ex-works

At 50 units/month, the monthly import duty spend = 50 × ₹10,990 = **₹5,49,500 per month** in duties alone. Switching to an ALMM-listed domestic alternative eliminates this, directly improving EPC margins.
...
Before confirming any inverter purchase for a PM Surya Ghar project:

- **Step 1:** Download the current ALMM list from [MNRE](https://mnre.gov.in/almm-list/).
- **Step 2:** Match the exact model number, wattage, and firmware version.
- **Step 3:** Verify the manufacturer name matches the ALMM listing (brand name vs legal entity name sometimes differ).
- **Step 4:** Check the ALMM validity date, listings have an expiry and renewal cycle.
- **Step 5:** Retain the downloaded ALMM list version and date as project documentation.

## Domestic vs Imported Inverter: True Cost Comparison

With BCD factored in, the cost advantage of imported inverters narrows substantially or reverses. This comparison uses a 5kW string inverter as the reference:

| Factor | Imported Chinese 5kW | ALMM-listed India 5kW |
| --- | --- | --- |
| Ex-works / plant gate price | ₹22,000 | ₹26,000 |
| BCD (20% on CIF for import) | ₹4,400 | ₹0 |
| IGST (18%) | ₹4,752 | ₹4,680 |
| Freight (India) | ₹800 | ₹400 |
| **Total landed cost** | **₹31,952** | **₹31,080** |
| PM Surya Ghar eligible? | Only if ALMM-listed | Yes (ALMM-listed) |
| RMA wait time | 4–8 weeks (import cycle) | 48–72 hours (domestic SLA) |

The imported brand's landed cost is only marginally lower, and disappears entirely when ALMM eligibility and warranty service costs are included. For EPCs serving PM Surya Ghar projects, the imported option carries subsidy disqualification risk that makes the choice straightforward. [CBIC's Customs Tariff notifications](https://www.cbic.gov.in/){target="_blank" rel="noopener"} provide the authoritative BCD rate schedule for solar equipment HS codes, updated with each Union Budget.

## Policy Risk: What EPCs Must Watch for in 2026 and Beyond

BCD rates are determined by Union Budget notifications and can change annually. EPCs with forward order books need to track three policy signals:

- **BCD revision upward**: if the government increases BCD on inverters from 20% to 30% (as has been discussed for a phased approach similar to modules), the landed cost of imported inverters jumps further. Domestic alternatives become even more attractive.
- **ALMM list expansion**: MNRE periodically adds new manufacturers and models. EPCs should monitor for additions of new ALMM-compliant brands that could offer competitive alternatives.
...
For the full EPC procurement framework, read the [inverter procurement India guide](/blog/inverter-procurement-india/) and the [solar EPC India overview](/blog/solar-epc-india/).
