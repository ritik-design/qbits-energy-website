---
title: "PM Surya Ghar Documents Required Checklist"
...
description: "PM Surya Ghar documents required: Aadhaar, electricity bill, bank details, and property proof. Full checklist to avoid rejection in 2026."
category: "Policy"
date: 2026-06-05
...
keywords:
  ...
  - documents for solar subsidy india
  - pm surya ghar eligibility documents
faqs:
  - q: "What is the most important document for PM Surya Ghar application?"
    a: "The electricity bill from your DISCOM is the single most critical document. It must be in the owner's name, show the correct consumer number, and be recent (typically within 3 months). Without a valid electricity bill, the portal will reject your application at the initial verification stage. All other documents - Aadhaar, PAN, bank passbook - are validated against the name and address printed on this electricity bill."
  - q: "Can I apply for PM Surya Ghar if the electricity meter is in a family member's name?"
    a: "The electricity connection must be in the applicant's name for the subsidy to disburse to their bank account. If the meter is in a parent's or spouse's name, you must first transfer the connection to your name at the DISCOM office before applying. Some DISCOMs allow a No Objection Certificate (NOC) from the registered consumer along with a relationship proof, but this varies by state. Contact your local DISCOM to confirm their specific policy."
  - q: "Is an Aadhaar card mandatory for PM Surya Ghar?"
    a: "Yes, Aadhaar is mandatory. The PM Surya Ghar portal uses Aadhaar-based e-KYC to verify your identity. Your Aadhaar number must be linked to your active mobile number so you can complete OTP-based authentication. If your Aadhaar is not linked to a mobile number, visit your nearest Aadhaar enrolment centre to link it before beginning the application. Both the Aadhaar number and mobile OTP are required at registration."
  - q: "What type of bank account is needed for subsidy disbursal?"
    a: "The subsidy amount under PM Surya Ghar is transferred directly to the applicant's bank account via PFMS (Public Financial Management System). You need a savings account in your own name at any scheduled bank or cooperative bank. The account must be operational and the IFSC code must be valid. Joint accounts are accepted provided the primary account holder's name matches the application. Post office savings accounts with IPPB are also accepted in most states."
  - q: "Do I need a property ownership document if I am a tenant?"
    a: "Tenants are generally not eligible for PM Surya Ghar subsidy because the scheme requires the applicant to own the roof on which panels are installed. If you rent a property, the landlord must be the applicant. However, if you own a flat in a housing society, the society's NOC along with your flat registration document serves as the property proof. Leasehold properties require the lease deed. Always verify eligibility with your local DISCOM before proceeding."
  - q: "How recent must the electricity bill be?"
    a: "Most DISCOMs require the electricity bill to be from the last two to three billing cycles - typically within 90 days of the application date. A bill older than three months may trigger a re-submission request. If your billing cycle is bimonthly, ensure the bill shows a date within the past two cycles. Some states like Gujarat and Maharashtra accept bills up to six months old, but submitting a recent bill avoids unnecessary processing delays."
  - q: "Is a PAN card required for PM Surya Ghar?"
    a: "PAN card is required for subsidy claims exceeding ₹50,000 in a single financial year under the Income Tax Act provisions applicable to government transfers. Since the maximum subsidy under PM Surya Ghar can reach ₹78,000 for a 3 kW system, PAN is effectively mandatory for all standard applications. Some states also require PAN for DISCOM registration. Ensure your PAN is linked to Aadhaar (as mandated by the Income Tax department) before applying."
  - q: "What happens if my submitted documents have a name mismatch?"
    a: "A name mismatch between Aadhaar, electricity bill, bank account, and PAN card is one of the top three reasons for PM Surya Ghar application rejection. If your name appears differently across documents - for example, initials on the electricity bill but full name on Aadhaar - you must first reconcile this. Visit your DISCOM to update the electricity account name, or raise a name-change request with Aadhaar. Processing a mismatch can add four to six weeks to your application timeline."
  - q: "Can I upload mobile phone photos of documents or do I need scans?"
    a: "The PM Surya Ghar portal accepts both scanned copies and clear mobile phone photographs. However, the image must meet minimum quality standards: no blur, complete document visible within frame, no shadows obscuring text, and file size typically under 2 MB per document (portal specifies this at upload). JPEG and PDF are accepted formats. Documents with glare, cut edges, or low resolution are flagged for re-upload, which delays your application by 5 to 10 working days."
  - q: "Do I need to re-submit documents after installation?"
...
| --- | --- | --- | --- |
| **Identity proof** | Aadhaar card (both sides) | JPEG / PDF | Mobile OTP-linked |
| **Tax identity** | PAN card | JPEG / PDF | Linked to Aadhaar |
| **Electricity proof** | DISCOM electricity bill | JPEG / PDF | ≤ 90 days old, consumer name matches |
| **Bank proof** | Passbook first page or cancelled cheque | JPEG / PDF | Account in applicant's name, IFSC visible |
| **Property proof** | Sale deed / flat allotment letter / lease deed | PDF | Matches roof ownership |
| **Photograph** | Passport-size photo | JPEG | White background, clear face |
| **Post-install** | Vendor completion certificate | PDF | Issued by empanelled vendor |
| **Post-install** | System installation photograph | JPEG | Roof + panels + inverter label visible |
...
- Enabled for NEFT/RTGS (standard for all bank accounts)

Submit the first page of your bank passbook showing your name, account number, and IFSC code, or a cancelled cheque showing the same information. Post office savings accounts through India Post Payments Bank (IPPB) are accepted in several states including UP, Bihar, and Rajasthan. The [PFMS portal](https://pfms.nic.in/){target="_blank" rel="noopener"} manages all direct benefit transfers under the scheme.
...
## The 5-Step Document Preparation Framework

Preparing documents in the right order prevents the most common application errors. Follow this framework before touching the portal.
...
The central PM Surya Ghar scheme has a standard document set, but individual DISCOMs add their own requirements. The table below covers major states where additional documents are commonly asked.

| State | DISCOM | Additional Documents |
| --- | --- | --- |
| **Delhi** | BSES / TPDDL | Voter ID or passport as additional ID in some cases |
| **Maharashtra** | MSEDCL | Society NOC for apartment buildings |
| **Gujarat** | PGVCL / UGVCL | Surya Gujarat scheme form (for state top-up subsidy) |
| **Tamil Nadu** | TANGEDCO | Patta (land ownership certificate) for individual plots |
| **Rajasthan** | JVVNL / AVVNL | Revenue record (jamabandi) for rural plots |
| **UP** | UPPCL | Ward certificate from local body for urban plots |
...
Always verify current requirements with your specific DISCOM before submitting, as these requirements are updated periodically. Your [empanelled vendor](/blog/empanelled-vendor-pm-surya-ghar/) typically knows the current DISCOM requirements in your state and can guide you through the process, and a directory such as finding a local solar installer is a useful starting point if you have not shortlisted one yet.
...
Once your documents are submitted and your application is live, monitoring its progress is important. The PM Surya Ghar portal provides a status tracker at [pmsuryaghar.gov.in](https://pmsuryaghar.gov.in/) where you can log in with your registered mobile number and check the current stage of processing.
...
Use this as your last verification before pressing the submit button on the PM Surya Ghar portal:

- Aadhaar number entered correctly (12 digits, no spaces)
- Mobile OTP received and entered within 30 seconds
- Electricity bill: applicant's name, consumer number clearly visible, ≤ 90 days old
- PAN card: correct 10-character alphanumeric, linked to Aadhaar
- Bank account: correct account number, valid IFSC, account in applicant's name
- Property document: shows applicant's ownership of the installation site
- Passport photograph: white background, clear, within file size limit
- All document names match across Aadhaar, electricity bill, and bank records

Submitting with all items checked reduces average processing time from the national average of 45 days to approximately 25 days in most states with active DISCOM processing teams. The [PM Surya Ghar subsidy amount guide](/blog/pm-surya-ghar-subsidy-amount/) gives you the exact figures to expect once your verified application clears.

The paperwork is a one-time investment. After that, 25 years of reduced electricity bills starts the day your panels are commissioned.
