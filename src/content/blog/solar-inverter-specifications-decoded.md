...
- Grid rejection during commissioning
- Equipment damage on shared circuits
- Compliance failures
...
- Suitable for monsoon, coastal salt, desert dust

## 6. Surge Protection (DC and AC)
...
- Maintain full output to **45–50°C ambient**
...
| Protocol | Use |
| --- | --- |
| Wi-Fi | Residential primary |
| 4G/LTE | Remote commercial |
...
| --- | --- |
| DC Oversizing | 100–150% |
| Start-up voltage | 120–180V |
| MPPT efficiency | 99.5%+ |
| THD | <3% (ideally <2%) |
| IP rating | IP66 |
| Peak efficiency | 98%+ |
| Weighted efficiency | 97.5%+ |
| Operating temp | Full output to 45–50°C |
