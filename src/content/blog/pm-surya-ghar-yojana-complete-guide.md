...
Every month, millions of Indian homeowners pay electricity bills that could be zero — or very close to zero — under a scheme that has existed since February 2024. PM Surya Ghar Muft Bijli Yojana provides the Government of India's largest-ever residential rooftop solar subsidy: up to ₹78,000 per household, plus 300 units of free electricity every month from a 3 kW system. Yet awareness remains patchy, application rates lag targets, and many homeowners who do apply lose their subsidy claim because of a single avoidable error — an inverter that is not on the MNRE [ALMM list](/glossary/almm-list/).

This guide covers everything from subsidy slabs and eligibility to the exact five-step application process, state-wise additional subsidies, common mistakes, and what to look for in an inverter to protect your claim.
...
The scheme replaces the earlier Grid Connected Rooftop Solar Programme Phase II and operates through a single national portal at [pmsuryaghar.gov.in](https://pmsuryaghar.gov.in/){target="_blank" rel="noopener"}, co-ordinated by [MNRE](https://mnre.gov.in/){target="_blank" rel="noopener"} and implemented through state DISCOMs. Understanding the scheme from end to end — not just the subsidy headline — is what separates a successful application from a stalled one.
...
Those numbers explain why the scheme received over 1.5 crore registrations within 18 months of launch, according to data tracked by [Mercom India](https://www.mercomindia.com/){target="_blank" rel="noopener"}. The financial case, even without subsidies, is compelling. With the subsidy, it is close to irresistible for anyone who owns their roof.
...
The central subsidy under PM Surya Ghar is structured in two slabs, with a hard cap at 3 kW regardless of the size of system you install. The table below shows the exact amounts for the 2026 scheme year.
...
- **Empanelled vendor and ALMM equipment** — the installation must be carried out by a DISCOM-empanelled vendor using [ALMM](/glossary/almm-list/)-listed inverters and panels. This is the single most common cause of rejected claims.
...
Visit [pmsuryaghar.gov.in](https://pmsuryaghar.gov.in/){target="_blank" rel="noopener"} and create an account using your mobile number, state, and DISCOM name. You will need your electricity consumer number from your bill. The portal sends an OTP to your registered mobile. Complete Aadhaar-based e-KYC through the portal.

**Documents needed at this stage:** Electricity bill (consumer number and DISCOM name), Aadhaar number, mobile number linked to Aadhaar.
...
Once you receive DISCOM feasibility approval (the portal shows a green status update), you can select a vendor. The portal lists all empanelled vendors by state and district, with contact details.
...
- Confirm the specific inverter model proposed is on the [ALMM inverter list at MNRE](https://mnre.gov.in/almm-list/){target="_blank" rel="noopener"}.
...
MNRE then verifies the documents and initiates direct bank transfer. The portal shows a disbursement status tracker.
...
1. Go to [mnre.gov.in/almm-list/](https://mnre.gov.in/almm-list/){target="_blank" rel="noopener"} (or the PM Surya Ghar portal's equipment search).
...
The PM Surya Ghar portal logs millions of applications. DISCOM officers and scheme administrators report the same cluster of errors repeatedly. Here are the ones most likely to delay or deny your claim.
...
For homeowners who need financing assistance for the CAPEX route, the [inverter financing options guide](/blog/inverter-financing-options-in-india/) covers MNRE's bank partnership programme, which offers concessional home loans for PM Surya Ghar applicants through SBI, Canara Bank, PNB, and Bank of Baroda at subsidised interest rates.
...
PM Surya Ghar crossed 1 crore (10 million) registrations on the national portal by early 2026 — matching the scheme's target number of registered applicants. However, registrations are not the same as commissioned installations. As of Q1 2026, actual commissioned installations under the scheme stand at approximately 30–35 lakh (3.0–3.5 million) households, according to [Mercom India](https://www.mercomindia.com/){target="_blank" rel="noopener"} tracking of MNRE data.
