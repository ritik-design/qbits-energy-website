...
keywords:
  ...
  - kusum yojana solar pump subsidy
  - kusum yojana apply kaise karein
  - kisan solar subsidy
  - kusum component b c hindi
faqs:
  - q: "KUSUM Yojana क्या है?"
    a: "KUSUM Yojana (Kisan Urja Suraksha evam Utthaan Mahabhiyan) भारत सरकार की किसानों के लिए solar subsidy scheme है। इसमें तीन components हैं: Component A (agricultural land पर solar plants), Component B (standalone solar pumps diesel pumps replace करने के लिए), और Component C (grid-connected pumps का solarisation)। किसानों को 60% subsidy मिलती है।"
  - q: "KUSUM Yojana में कितनी subsidy मिलती है?"
    a: "KUSUM Yojana में Component B और C के लिए 30% central + 30% state = 60% subsidy मिलती है। किसान 40% खुद pay करता है। कुछ states (Rajasthan, Gujarat, Maharashtra) 10-20% और दे देती हैं, जिससे किसान का हिस्सा 20-30% तक कम हो जाता है।"
  - q: "KUSUM और PM Surya Ghar में क्या फर्क है?"
    a: "PM Surya Ghar घर के rooftop solar के लिए है - domestic connection वाले homeowners। KUSUM किसानों और agricultural users के लिए है - agricultural connection या agricultural land। दोनों अलग-अलग schemes हैं, अलग portals पर apply होती हैं।"
  - q: "KUSUM Component B के लिए कैसे apply करें?"
    a: "KUSUM Component B (standalone solar pump) के लिए अपने state के agricultural department या DISCOM से contact करें। हर state का अलग portal है। Rajasthan में rajkisan.rajasthan.gov.in, Maharashtra में MSEDCL portal, Gujarat में GEDA। Application offline या online दोनों तरीकों से होती है।"
  - q: "KUSUM Yojana में कौन eligible है?"
    a: "KUSUM में eligible हैं: किसान जिनके पास agricultural land हो (Component A), किसान जिनके पास agricultural pump हो without grid (Component B), किसान जिनके पास existing grid-connected agricultural pump हो (Component C)। Domestic connection वाले homeowners KUSUM के लिए eligible नहीं हैं।"
  - q: "क्या एक किसान PM Surya Ghar और KUSUM दोनों का लाभ ले सकता है?"
    a: "हाँ, अगर किसान के पास घर के लिए domestic connection और खेत के लिए agricultural connection दोनों हों। PM Surya Ghar घर के rooftop solar के लिए, KUSUM खेत के pump के लिए। दोनों separate applications, separate systems, separate connections। दोनों एक साथ benefit possible है।"
  - q: "KUSUM Component A क्या है - land lease income कितनी मिलती है?"
...
**Subsidy:**
- Central: 30% of benchmark cost
- State: 30% of benchmark cost
- **Farmer pays: 40%** (soft loan available)

**Example:** 5 HP solar pump, benchmark cost ₹3.5 lakh
- Central subsidy: ₹1.05 lakh
- State subsidy: ₹1.05 lakh
...
| Pump Size | Solar System | Annual Export Income | Annual Savings |
| --- | --- | --- | --- |
| 3 HP | 4.5 kW | ₹20,000-35,000 | ₹15,000-25,000 |
...
| --- | --- | --- |
| **Beneficiary** | Farmers (agricultural users) | Homeowners (domestic connection) |
| **Application type** | Agricultural connection/land | Domestic electricity connection |
| **Portal** | State-wise (DISCOM/agriculture dept) | pmsuryaghar.gov.in (national) |
| **Subsidy** | 60% (30% central + 30% state) | ₹78,000 max (varies by kW) |
| **Timeline** | 3-12 months | 45-90 days |
| **ALMM required** | Yes | Yes |
| **Net metering** | Yes (Component C) | Yes |

[PM Surya Ghar vs KUSUM detailed comparison](/blog/pm-surya-ghar-vs-kusum-yojana/) - जो नहीं जानते किसे apply करना है उनके लिए।

## KUSUM Component B Apply Kaise Karein

KUSUM के लिए कोई single national portal नहीं है - state-wise process है।

### State-Wise KUSUM Application Contacts

| State | Application Method | Contact |
| --- | --- | --- |
| **Rajasthan** | rajkisan.rajasthan.gov.in | Rajasthan Agriculture Dept |
| **Maharashtra** | MSEDCL portal | Mahaurja / MSEDCL office |
| **Gujarat** | GEDA portal | geda.gujarat.gov.in |
| **Uttar Pradesh** | UPNEDA portal | District agriculture office |
| **Bihar** | Bihar Agriculture Dept | District agriculture office |
| **MP** | MPUVNL | State energy department |
| **Haryana** | HAREDA portal | DISCOM office |
...
| Document | Component A | Component B | Component C |
| --- | --- | --- | --- |
| Aadhaar Card | ✓ | ✓ | ✓ |
| Land records (khasra/khatoni) | ✓ | ✓ | ✓ |
| Existing pump details | ✗ | ✗ | ✓ |
| Agricultural connection bill | ✗ | ✗ | ✓ |
| Bank passbook | ✓ | ✓ | ✓ |
| Farmer registration | ✓ | ✓ | ✓ |
...
## KUSUM Component B Ka Financial ROI

**Example: 5 HP diesel pump, Rajasthan**

| Item | Before KUSUM | After KUSUM |
| --- | --- | --- |
| Annual diesel cost | ₹1,20,000 | ₹0 |
| Pump maintenance | ₹8,000 | ₹2,000 (solar) |
| Solar pump investment | - | ₹1,40,000 (40% farmer share) |
| Annual saving | - | ₹1,26,000 |
...
- Average payback for 5 HP solar pump: 14 months
...
| State | Status Check Method |
| --- | --- |
| Rajasthan | rajkisan.rajasthan.gov.in portal |
| Maharashtra | MSEDCL district office or website |
| Gujarat | GEDA portal or helpline |
...
किसान जो KUSUM apply करना चाहते हैं, उनके लिए practical tips:

**Before Application:**
- अपने khasra और khatoni records update करें - current revenue records जरूरी हैं
- District agriculture department से KUSUM nodal officer का contact नंबर लें
- ALMM list पर pump manufacturer verify करें - [mnre.gov.in/almm-list/](https://mnre.gov.in/almm-list/){target="_blank" rel="noopener"}
- 2-3 empanelled vendors से quotes लें (same specifications पर)

**During Application:**
- All documents की photocopies सहित submit करें
- Application receipt लें - tracking के लिए
- Follow-up schedule बनाएँ - 2 हफ्ते में एक बार nodal office check-in

**After Installation:**
- Installation certificate सँभाल कर रखें
