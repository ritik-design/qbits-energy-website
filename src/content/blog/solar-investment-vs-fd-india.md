...
keywords:
  ...
  - solar roi vs fixed deposit
  - solar irr india homeowner
  - is solar better than fd india
faqs:
  - q: "What is the return on solar investment compared to FD in India?"
    a: "A 3 kW rooftop solar system in India delivers an internal rate of return (IRR) of approximately 18–22% over its 25-year life, after accounting for system cost, PM Surya Ghar subsidy, and electricity savings at ₹8–10 per unit. A bank Fixed Deposit (FD) at 7.5% per annum delivers a nominal 7.5% pre-tax return, or roughly 5–6% post-tax for individuals in the 20–30% tax bracket. Solar wins decisively on return, but FD is fully liquid while solar is a fixed asset."
  - q: "Is solar investment tax-free in India?"
    a: "Electricity savings from rooftop solar are not taxed as income for residential homeowners - the savings simply reduce your bill. The PM Surya Ghar subsidy is also not taxable for individuals. However, interest income from FDs is fully taxable. This tax asymmetry further widens the effective return gap between solar and FD. For commercial buyers, accelerated depreciation (40% in Year 1) creates an additional tax benefit on capex."
  - q: "What happens to solar returns if electricity tariffs increase?"
    a: "Rising electricity tariffs directly increase solar returns. India's electricity tariffs have increased at approximately 5–7% annually over the past decade. A solar system locked in at today's installation cost but saving electricity at tomorrow's higher tariffs delivers significantly more than the base IRR calculation. FD returns, on the other hand, tend to lag inflation and tariff growth. The tariff-escalation upside is one of solar's strongest arguments versus FD."
  - q: "Can I withdraw my solar investment like an FD?"
    a: "No. Solar is an illiquid investment. The panels and inverter are physically installed on the roof. You cannot 'withdraw' the solar investment at short notice the way you can break an FD. However, solar adds to property value - studies from the United States show a 3–4% premium, and Indian data suggests similar trends in urban markets. If you sell the property, the solar system typically transfers with it and supports a higher asking price."
  - q: "What is the payback period for a 3 kW solar system in India?"
    a: "A 3 kW solar system in India typically costs ₹1.5–2.0 Lakh post-subsidy (after the PM Surya Ghar central subsidy of ₹78,000 is applied). At ₹8 per unit and 4–5 peak sun hours per day, the system generates approximately 12–15 units daily, saving ₹35,000–₹45,000 annually. This gives a simple payback period of 3.5–5 years, compared to a solar system life of 25+ years. The remaining 20+ years of free electricity is pure return."
  - q: "Does solar return depend on how much electricity I use?"
    a: "Yes. High-consumption households gain more from solar. A household using 500 units per month at ₹10/unit saves ₹60,000 annually from a 5 kW system. A household using 200 units per month at ₹7/unit saves less. In net metering states, surplus generation is credited to the next bill, extending the effective benefit even if the household is away. For households with bills below ₹3,000 per month, the IRR may fall to 12–15%, which is still better than FD but closer to equity market returns."
  - q: "Is solar a good investment for someone aged 55 or older in India?"
    a: "A homeowner aged 55 with a 25-year system life will not personally see the full system life, but will still recover the investment in 4–6 years and enjoy 15–20 years of free electricity. Children who inherit the home continue to benefit. For a 55-year-old with a short-term liquidity need, a hybrid approach - investing 50% in solar and keeping 50% in FD - offers the best balance. The solar portion delivers higher returns; the FD provides liquidity."
  - q: "What happens to solar returns during cloudy months?"
...
| --- | --- |
| Principal | ₹3,00,000 |
| Interest rate | 7.5% p.a. (current best rate - SBI, HDFC, Axis for 1–5 year FD) |
| Annual income | ₹22,500 |
| Tenure | 25 years |
| Tax rate (30% bracket) | ₹22,500 × 30% = ₹6,750 tax/year |
| Post-tax annual income | ₹15,750 |
| Total post-tax income over 25 years | ₹3,93,750 (simple basis) |
| Compounded FV at 7.5% (pre-tax, 25 yr) | ₹18,06,000 |

The FD's headline 7.5% becomes roughly 5.25% post-tax in the highest bracket. For senior citizens with a 5% FD rate and lower income tax, the effective return is even lower.

### Solar Investment Scenario (3 kW System)

| Parameter | Value |
| --- | --- |
| Gross system cost | ₹1,80,000 (3 kW at ₹60,000/kW installed) |
| PM Surya Ghar subsidy (central) | ₹78,000 |
| Net capex (from own funds) | ₹1,02,000 |
| Remaining ₹3,00,000 deployed | ₹3,00,000 total, of which ₹1,02,000 is net capex |
| Annual generation | 3 kW × 5 PSH × 365 = 5,475 kWh/year |
| Tariff savings at ₹8/unit | ₹43,800/year |
| Tariff savings at ₹10/unit | ₹54,750/year |
| Simple payback | ~2.3–3.5 years (on net capex) |
...
## What Solar Does Better Than FD
...
## What FD Does Better Than Solar
...
| | Solar | Fixed Deposit |
| --- | --- | --- |
| **IRR (indicative)** | 18–22% (₹8/unit) | 7.5% (pre-tax) |
| **Post-tax return** | ~18–22% (savings not taxed) | ~5.25% (30% bracket) |
| **Liquidity** | ✗ Illiquid for 5+ years | ✓ Breakable in 24 hours |
| **Inflation hedge** | ✓ Savings grow with tariff hikes | ✗ Fixed rate |
| **Property value** | ✓ Increases resale value | ✗ No property benefit |
| **Maintenance needed** | ✓ Yes (cleaning, monitoring) | ✗ Zero |
| **Subsidy benefit** | ✓ ₹78,000 PM Surya Ghar | ✗ None |
| **Risk** | Moderate (performance-dependent) | Very low (DICGC-insured) |
| **Best for** | Homeowners, 25+ year horizon | Anyone needing liquidity |

## Scenarios Where FD Wins Over Solar
...
The PM Surya Ghar subsidy restructures the IRR calculation significantly. Without subsidy, the IRR on a ₹1,80,000 gross system at ₹8/unit is approximately 17%. With the ₹78,000 subsidy reducing effective capex to ₹1,02,000, the IRR jumps to 22%+.

| Scenario | Net Capex | Annual Savings | IRR |
| --- | --- | --- | --- |
| No subsidy, ₹8/unit | ₹1,80,000 | ₹43,800 | ~17% |
| With PM Surya Ghar subsidy, ₹8/unit | ₹1,02,000 | ₹43,800 | ~24% |
| With subsidy, ₹10/unit (tariff rise) | ₹1,02,000 | ₹54,750 | ~30% |
| No subsidy, ₹6/unit (conservative) | ₹1,80,000 | ₹32,850 | ~12% |

For the full PM Surya Ghar subsidy calculation, read the [PM Surya Ghar subsidy amount guide](/blog/pm-surya-ghar-subsidy-amount/).
