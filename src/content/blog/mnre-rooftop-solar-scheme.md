...
description: "MNRE's PM Surya Ghar scheme gives up to ₹78,000 subsidy for rooftop solar in India. Guide to ALMM rules, empanelled vendors, and applications."
category: "Policy"
date: 2026-06-05
...
keywords:
  ...
  - ministry of new and renewable energy solar scheme
  - mnre solar subsidy india
  - mnre empanelled vendor solar
faqs:
  - q: "What is the MNRE rooftop solar scheme?"
    a: "The MNRE (Ministry of New and Renewable Energy) rooftop solar scheme, formally called PM Surya Ghar Muft Bijli Yojana, provides central government subsidies for residential rooftop solar installations in India. The scheme offers up to ₹78,000 for a 3 kW system, requires ALMM-listed components, and mandates installation by empanelled vendors registered on the national portal at pmsuryaghar.gov.in. The scheme targets 10 million households and is India's largest residential solar initiative."
  - q: "What is ALMM and why does it matter for MNRE rooftop solar?"
    a: "ALMM stands for Approved List of Models and Manufacturers - a list maintained by MNRE of solar panels and inverters that meet Indian quality standards. Under the rooftop scheme, all components used in a subsidised installation must appear on the ALMM list. Installers who use non-listed components cannot pass the DISCOM inspection, and the subsidy is withheld. MNRE updates the ALMM list quarterly. Both solar panels and inverters must be individually verified before installation begins."
  - q: "How much subsidy does MNRE provide for rooftop solar?"
    a: "MNRE provides central subsidies of ₹30,000 per kW for the first 2 kW and ₹18,000 per kW for the third kW - giving a maximum of ₹78,000 for a 3 kW system. Systems above 3 kW receive the same maximum central subsidy of ₹78,000. Some states add a top-up subsidy on top of the central amount. The subsidy is transferred directly to the applicant's bank account via PFMS after DISCOM inspection and net metering activation."
  - q: "Who can apply for the MNRE rooftop solar scheme?"
    a: "Any Indian household with a residential DISCOM electricity connection, a valid Aadhaar card, and ownership of the roof (or rights to install solar on it) can apply. There is no income ceiling - the scheme is open to all residential consumers regardless of income. The applicant must be the registered electricity consumer at the installation address. Apartments, independent houses, and society buildings all qualify. Commercial, agricultural, and industrial connections are excluded from the residential subsidy."
  - q: "What is an empanelled vendor under MNRE rooftop solar?"
    a: "An empanelled vendor is a solar installation company that has registered on the PM Surya Ghar portal, provided proof of past project experience, holds relevant certifications, and has committed to following MNRE's quality and pricing guidelines. Only empanelled vendors can carry out subsidised installations under the scheme. Applicants must select an empanelled vendor from the portal's list for their pincode. Installing through a non-empanelled vendor disqualifies the application from subsidy."
  - q: "Does MNRE rooftop solar cover hybrid inverters?"
    a: "Yes, hybrid inverters can be used under the scheme provided the specific model appears on the ALMM list. However, the subsidy amount is calculated based on the solar system capacity, not the battery size. The battery component is not subsidised under the central scheme (though some states offer separate battery subsidies). A hybrid system gives you solar subsidy benefits plus battery backup capability - a combination increasingly popular in power-cut-prone states."
  - q: "What is the difference between MNRE scheme and state-level solar schemes?"
    a: "MNRE operates the central PM Surya Ghar scheme with standardised national subsidies and processes through the national portal. State governments operate additional schemes - such as Surya Gujarat, Tamil Nadu Solar Policy, and UP Solar Policy - that typically add a top-up subsidy, modify eligibility criteria for their state, or operate separate portals. In most states, both central and state schemes can be combined. The central scheme's ALMM and empanelled vendor requirements still apply regardless of which state scheme is also active."
  - q: "How long does MNRE rooftop solar subsidy take to arrive?"
...
> **TL;DR**
> - MNRE runs the scheme through a layered DBT structure: MNRE sets policy, the state nodal agency coordinates, the DISCOM inspects and activates net metering, and PFMS transfers the subsidy.
> - Central subsidy is ₹30,000/kW for the first 2 kW and ₹18,000 for the third kW, capped at ₹78,000 regardless of system size above 3 kW.
> - Only ALMM-listed panels and inverters qualify, and only MNRE-empanelled vendors can execute a subsidised installation.
> - The official target is 30 days from installation to subsidy disbursal, but the real-world average is 45 to 90 days depending on state DISCOM capacity.
> - State schemes such as Surya Gujarat and Tamil Nadu's programme add a top-up subsidy on top of the central amount in most states.

India's total installed rooftop solar capacity crossed 18 GW by early 2026, according to [JMK Research](https://jmkresearch.com/){target="_blank" rel="noopener"}, with residential installations growing at over 40% annually, driven almost entirely by the PM Surya Ghar scheme, a pace of growth mirrored by the expansion of residential solar installation capacity among EPC firms nationally. The [ALMM list](/glossary/almm-list/) and empanelled vendor framework are the quality guardrails that make this possible at scale.
...
| Layer | Entity | Role |
| --- | --- | --- |
| **Policy & fund** | MNRE (central government) | Sets subsidy amounts, ALMM requirements, and scheme guidelines |
| **State nodal agency** | GEDA, TNEDA, HAREDA, etc. | Coordinates between MNRE and DISCOMs; handles state top-up subsidies |
| **DISCOM** | BSES, MSEDCL, BESCOM, etc. | Verifies applications, conducts inspections, activates net metering |
| **Empanelled vendor** | Registered installer | Installs system, uploads completion data to portal |
| **Applicant** | Homeowner | Applies, pays net cost, provides bank account for DBT |
| **PFMS** | Finance Ministry system | Executes the actual bank transfer of subsidy |
...
| --- | --- | --- | --- |
| 1 kW | ₹30,000/kW | ₹30,000 | ₹45,000–₹60,000 |
| 2 kW | ₹30,000/kW | ₹60,000 | ₹80,000–₹1,10,000 |
...
Before the ALMM framework, the Indian rooftop solar market had significant quality problems: uncertified Chinese inverters, substandard panels, and unverifiable specifications. MNRE introduced the ALMM to ensure that subsidy-funded installations use components that will actually last 25 years.

### What ALMM compliance means for buyers
...
- Proof of past solar project experience (typically 3+ completed systems)
- GST registration
- Electrical contracting licence
- Agreement to use only ALMM-listed components
- Agreement to upload installation data to the portal upon completion
...
The [empanelled vendor guide](/blog/empanelled-vendor-pm-surya-ghar/) covers how to verify vendor empanelment status, what to include in your installation agreement, and what to do if your vendor fails to submit your completion report. Homeowners researching candidates before checking a name against the state's empanelled list can use a directory such as finding a local solar installer to shortlist companies with an established residential track record in their pincode.

## The MNRE 5-Step Application Process Framework

Every PM Surya Ghar application follows this framework regardless of state or DISCOM.
...
3. **Vendor selection and installation**: After feasibility approval, select an empanelled vendor from the portal's pincode-filtered list. Negotiate cost, confirm ALMM-listed components, sign agreement, and schedule installation. Requesting a structured, itemised quote (the kind produced by [solar quotation software](https://quickestimate.co/features/quotation-system/)) makes it easier to compare component-level pricing across two or three empanelled vendors before signing. Installation takes 1 to 3 days for residential systems.
4. **Net metering and inspection**: Your vendor submits the completion report. Your DISCOM schedules a physical inspection and replaces your meter with a [bidirectional smart meter](/glossary/bidirectional-meter/). Timeline: 15 to 45 days depending on state.
...
## Common Misconceptions About the MNRE Rooftop Scheme

Several widespread misunderstandings lead homeowners to either over-expect from the scheme or under-utilise it.

**Misconception 1: "The subsidy covers the entire installation cost"**
...
## MNRE Compliance Requirements for Inverters
...
The [solar inverter certifications guide](/blog/solar-inverter-certifications/) explains each certification in detail and shows how to verify compliance on official websites. For inverter sizing guidance, the [string sizing calculator](/string-sizing-calculator/) takes your roof area and panel count and recommends compatible inverter specifications within minutes.
