...
keywords:
  ...
  - solar system checkup india
  - solar inverter annual service india
faqs:
  - q: "How often should solar panels be cleaned in India?"
    a: "Solar panels in India should be cleaned monthly in dusty northern regions (Rajasthan, UP, Delhi, Haryana) and quarterly in coastal and southern states. Monsoon rains from June to September provide natural cleaning but leave a pollution film that must be removed in October. The two most critical cleaning events each year are pre-monsoon (May) and post-monsoon (October). Never clean panels between 10 AM and 3 PM when they are hot - thermal shock from cold water can micro-crack solar cells."
  - q: "What does a complete solar system annual maintenance checklist include in India?"
    a: "A comprehensive solar system annual maintenance checklist in India covers 10 items: panel cleaning (monthly or quarterly by region); string voltage check with a 1,000 V DC multimeter; inverter error log review; DC connector (MC4) inspection for corrosion and looseness; earthing continuity test; cable conduit inspection for rodent damage; battery state of health (SOH) check for hybrid systems; warranty registration status verification; net meter reading cross-check against monitoring app data; and structural mounting inspection for corrosion or loose fasteners."
  - q: "What is the best time of year for solar maintenance in India?"
    a: "India's climate creates four natural maintenance windows: May (pre-monsoon) for a full inspection before rain season; October (post-monsoon) for deep cleaning and connector inspection after the wet season; November to February (winter) for optimising panel tilt in northern states; and March to April (summer) for inverter ventilation check before peak thermal load. The most important single window is May - this is when MC4 connectors, cable conduits, and earthing should be inspected before the monsoon stress season begins."
  - q: "What is battery state of health (SOH) and how do I check it on my solar system?"
    a: "Battery State of Health (SOH) is a percentage measure of a battery's current capacity compared to its original rated capacity. A lithium iron phosphate (LFP) battery with SOH of 85% can store 85% of its original capacity. SOH is read from the Battery Management System (BMS) via the inverter's monitoring app or LCD display. An SOH below 70% means the battery is approaching end-of-life and should be budgeted for replacement within 1–2 years. LFP batteries typically maintain above 80% SOH for 2,000–3,000 charge cycles, or roughly 6–8 years at one cycle per day."
  - q: "Can I do solar maintenance myself or do I need a professional?"
    a: "Several annual tasks are homeowner-safe: panel cleaning, visual inspection for physical damage, monitoring app log review, and clearing dust from inverter vents. However, electrical tests - string voltage measurement (300–800 V DC is lethal without proper equipment), insulation resistance (megger) testing, and earthing continuity testing - require a licensed solar electrician with rated equipment. The annual professional inspection typically costs ₹2,000–₹5,000 and covers all tests that homeowners cannot safely perform themselves."
  - q: "How much generation does dust cause me to lose in India?"
    a: "Dust-related generation loss in India ranges from 5% in coastal and southern states to 15–25% in northern states during peak dust season (February to May). A 3 kW system in Delhi losing 15% to dust over 8 months loses approximately 500–600 units per year - equivalent to ₹4,000–₹5,000 in lost electricity savings. Monthly cleaning in high-dust regions pays back its cost many times over. The Bureau of Indian Standards recommends cleaning intervals based on local PM2.5 and PM10 levels, which vary significantly across Indian states."
  - q: "What should I check on my solar inverter every year?"
...
| --- | --- | --- |
| MC4 connectors (corrosion) | Arcing → fire risk; string failure | ₹20,000–₹50,000 damage; months of downtime |
| Earthing (loose bond) | Lightning surge destroys inverter | ₹40,000–₹80,000 inverter replacement |
| DC conduit (rodent damage) | Shorted string → fire | ₹30,000–₹60,000 damage |
| Inverter log (missed faults) | Gradual efficiency loss 5–15% | ₹25,000–₹50,000 in lost generation |
| Battery SOH (ignored) | Sudden capacity loss | ₹50,000–₹1,20,000 battery replacement |
...
**Complete May pre-monsoon checklist:**

**Panels:**
- Deep cleaning with mild soap solution and microfibre cloth (not high-pressure water)
...
- Check the 12-month fault log for any recurring codes
- Verify monitoring connection is active
...
**Monitor isolation resistance:** Ground fault errors are most common during monsoon due to water ingress into connectors and junction boxes. Check the monitoring app daily for isolation fault codes. If an ISO_Fault, GFCI, or IsoFault code appears, switch off the system from the AC breaker and DC isolator immediately and call a licensed electrician before restarting. Operating with an active ground fault is dangerous.

**Monitor generation consistency:** Compare daily generation against historical data. A consistent drop of 10–15% on clear-weather days (not attributable to cloud cover) indicates a panel or string issue. The [solar inverter app monitoring guide](/blog/solar-inverter-app-monitoring/) explains how to read generation trend charts and identify anomalies.

**Do not clean wet panels:** Cleaning panels while they are generating electricity and wet creates a slip and shock hazard. Let monsoon rains act as the primary cleaning agent during June–September. Schedule a thorough post-monsoon cleaning for October.

**Check inverter ventilation:** Monsoon humidity can cause condensation in inverter enclosures that lack adequate IP-rating. Check the inverter enclosure monthly for signs of internal moisture (fogging on the display, water marks inside visible through vents). If moisture is present inside the inverter, contact the service team immediately.

**What to watch for (call a technician if you see these):**
- Repeated ground fault errors (more than once in a week)
- Visible water damage to the inverter enclosure or any junction box
...
| Location | Approximate Latitude | Fixed Tilt | Recommended Winter Tilt |
| --- | --- | --- | --- |
| Delhi | 28.6°N | 25–28° | 38–42° |
| Jaipur | 26.9°N | 24–27° | 36–40° |
| Lucknow | 26.8°N | 24–27° | 36–40° |
| Chandigarh | 30.7°N | 28–30° | 42–45° |
| Ahmedabad | 23.0°N | 20–23° | 32–35° |
| Mumbai | 19.1°N | 16–19° | 26–29° |
...
- Clean all cooling vents with a dry brush. A can of compressed air is ideal for reaching inside vent slots.
- Verify that at least 30 cm of clearance exists above, below, and on both sides of the inverter. Remove any items stored near the inverter since the previous summer.
- Check the cooling fan is operating (you should hear it running when the inverter is at normal operating temperature). A rattling or non-rotating fan must be replaced before peak summer.

**Installation environment:**
- If the inverter is on a south-facing or west-facing wall that receives direct afternoon sun, consider adding a shade structure (maintaining clearance) to reduce ambient temperature at the unit by 5–8 °C.
- If the inverter is in an enclosed room or cabinet, ensure the room has adequate ventilation. An enclosed meter room without airflow can reach 50 °C in May even before the inverter's own heat is added.
...
- Review the fault log in the monitoring app and note any new fault codes since the last review
- Check the inverter display for any persistent warning indicators
- Verify that the monitoring WiFi or 4G connection is active and that data gaps are not occurring

**Annual (professional, as part of the annual inspection):**
- Full 12-month fault code analysis with trend identification
...
- Inverter display reading and general status observation
...
| Season | Months | Primary Focus | Key Tasks |
| --- | --- | --- | --- |
| Pre-monsoon | May | System safety inspection | MC4, earthing, conduit, deep clean |
| Monsoon | Jun–Sep | Remote monitoring, no electrical work | Daily app monitoring, isolation faults |
| Post-monsoon | Oct | Output restoration | Panel clean, connector re-inspection, string voltage |
| Winter | Nov–Feb | Generation optimisation | Panel tilt adjustment (north India), efficiency review |
