...
relatedTerms:
  ...
  - { slug: "fast-charging", term: "Fast Charging" }
  - { slug: "hybrid-inverter", term: "Hybrid Inverter" }
  - { slug: "ev-charger", term: "EV Charger" }
  - { slug: "power-rating", term: "Power Rating" }
  - { slug: "energy-rating", term: "Energy Rating" }
faqs:
...
Cycle life. High C-rate operation reduces cycle life.

Inverter compatibility. Inverter peak power must match battery peak C-rate capability.

EV charging time. C-rate determines fast-charge time.
...
| Tubular lead acid | 0.1C to 0.2C | 1C for 30s |
| AGM lead acid | 0.3C | 1C for 30s |
| LTO | 5C | 10C |

### C-rate and efficiency

Round-trip efficiency declines with C-rate:
...
EV passenger cars at 0.5C average, 1C to 3C during DC fast charging.
...
Cell imbalance after high-C operation. BMS balancing should resolve.

## Best practices

Size battery so daily peak power is below 0.5C continuous for stationary storage.
